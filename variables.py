# https://github.com/peisungtsai/Reptile-Pytorch-Implementation/blob/master/variables.py
"""
...
# def average_two(dict_list, count):
#     """
#     Averrage of list of state_dicts.
#     """
#     for param_tensor in dict_list[0]:
#         for c in range(0, count) :
#             dict_list[0][param_tensor] = dict_list[0][param_tensor] + dict_list[0][param_tensor]
#         for i in range(1, len(dict_list)):
#             dict_list[0][param_tensor] = dict_list[0][param_tensor] + dict_list[i][param_tensor]
#         dict_list[0][param_tensor] = dict_list[0][param_tensor]/(count+1)
